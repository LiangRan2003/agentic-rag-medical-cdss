...
**CDSS Agent:**
> 根据《慢性乙型肝炎防治指南（2022年版）》，慢性乙型肝炎（CHB）的抗病毒治疗是降低相关并发症和肝细胞癌（HCC）发生率、提高患者生存率的最重要措施。治疗原则以更积极抗病毒治疗为导向。
...
**CDSS Agent:**
> *(内部思考流可视化)*
> 🔍 Retriever Agent: 正在从向量库中检索相关文档...
> ⚖️ Validator Agent: 正在评估检索文档的相关性...
> ✍️ Synthesizer Agent: 正在生成回答，并进行幻觉校验...
> 
> 根据《中国社区获得性肺炎诊断和治疗指南2025》，社区获得性肺炎（CAP）的诊断主要依据以下核心条件（需同时满足）：
> - **社区发病**：患者在医院外（或入院后48小时内）出现肺炎相关症状。
> - **临床表现**：新近出现的咳嗽、咳痰或原有呼吸道疾病症状加重；发热（体温≥38℃）；肺实变体征和/或湿性啰音。
> - **影像学证据**：胸部影像学（X线或CT）显示新出现的斑片状浸润影等。**影像学是诊断CAP的必要条件。**
